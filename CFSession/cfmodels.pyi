...
class Proxy:
    ...
    def __init__(self, proxy: dict = None, proxy_hostname: str = None, proxy_scheme: str = None, proxy_port: int = None, username: str = None, password: str = None, host: str | Iterable[Literal['https','http']] = ['https','http'], resolve_by_proxy: bool = None) -> None: ...
